...
Это быстро - упал у дороги. Местность немного заболочена. Напялили телепузы, подошли и взяли.
...
С GPS попращался на высоте примерно 500м. Вернулся он уже только на земле. Допуская, что подъем был равномерным, я продолжил последовательность данных GPS в Excel до времени, соответствующему времени разрыва шара на видео - это точка максимальной высоты. Я так же добавил погрешность в 10%, чтобы видеть поле возможных значений. Таким образомы мы получили высоту 20-25км. Берем посередине, получаем **23км** - именно это значение используем для видео и отчетности.
